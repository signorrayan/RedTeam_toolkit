...
def loginuser(request):
   if request.method == 'GET':
       ...
       if user is None:
           return render(request, 'toolkit/login.html', {'form':AuthenticationForm(), 'error':'Invalid Username/Password'})
       else:
           login(request, user)
...
def cvedes(request):
    if request.method == 'GET':
        ...
        try:
            ...
            return render(request, 'toolkit/cvedes.html', {'error':'Bad data passed in. Try again.'})
    ...
    if request.method == 'GET':
        ...
        if form.is_valid():
            ...
            if result is not None:
                ...
                return render(request, 'toolkit/sshbruteforce.html', {'error': 'Not Found!'})

        return render(request, 'toolkit/sshbruteforce.html', {'error': 'Bad data passed in. Try again.'})


@login_required(login_url='/login/')
def rdpbruteforce(request):
    if request.method == 'GET':
        return render(request, 'toolkit/windows/rdpbruteforce.html', {'form' : IpscanForm()})
        ...
        if form.is_valid():
            ...
            if result is not None:
                ...
                return render(request, 'toolkit/windows/rdpbruteforce.html', {'error': 'Not Found!'})

        return render(request, 'toolkit/windows/rdpbruteforce.html', {'error': 'Bad data passed in. Try again.'})
